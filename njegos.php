...
<body>
    <header class= "row">
    <div class="dropdown show col-md-4">
        ...
        <form class= "row " action="" method="post">
            <div class="dropdown-menu col-md-12" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item" href="domaci.php">Njegoševi citati <i class="fa-solid fa-fire fa-lg fa-beat" style="color: rgba(255, 99, 71, 1); text-shadow: none;"></i></a>
            </div>
        </form>
    ...
    ?>
        <div class="carousel-item active">
            <?php 
            echo "<img src='njegosImages\\$img1' class='d-block' alt='First slide'>"; 
            ?>
        </div>
        <div class="carousel-item">
            <?php 
            echo "<img src='njegosImages\\$img2' class='d-block' alt='Second slide'>"; 
            ?>
        </div>
        <div class="carousel-item">
            <?php 
            echo "<img src='njegosImages\\$img3' class='d-block' alt='Third slide'>"; 
            ?>
        </div>
    </div>
    ...
    <section id = "quote">
    <?php
        $file = __DIR__ . "/text/njegos.txt";
        $quote = file($file);
        $random_key = array_rand($quote, 1);
        $shownQuote = $quote[$random_key];
        echo "<p class ='myQuote'>&ldquo; $shownQuote &ldquo;</p>";
    ?>
    </heder>
</section>
    <footer class="py-3">
